  ...
  return (
    <SafeAreaView  style={screenStyle.container} >
     ...
     <View  style={{flex:1, padding:10}} >
      ...
      style={{
        backgroundColor:AppColors.WHİTE,
        borderWidth:1,
        padding:5,
        margin:8,
        borderRadius:5,
...
{titleRequired  && (
        <Text style={{fontWeight : "500", fontSize: 16, color:AppColors.RED  }} >Lütfen başlık alanını doldurunuz</Text>
      ...
      style={{
        ...
        />
 {descriptionRequired  && (
     <Text style={{fontWeight : "500", fontSize: 16, color:AppColors.RED  }} >Lütfen Açıklama alanını doldurunuz</Text>
